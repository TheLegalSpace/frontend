...
export default function ArticleCard({
  ...
  return (
    <div className="flex gap-3 mt-3 border border-gray-200 rounded-xl overflow-hidden bg-white">
      {/* Dark thumbnail */}
      <div className="w-20 h-20 bg-gray-900 flex flex-col items-center justify-center shrink-0">
