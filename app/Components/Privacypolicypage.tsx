      ...
      <div className="max-w-360 mx-auto">
        ...
        <section className="mb-7">
          ...
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
            The Legal Space ("TLS", "we", "us", or "our") is a Nigerian legal technology platform that connects lawyers, law firms, and clients within a structured professional community. We are committed to protecting the privacy of every person who uses our platform and to handling personal information with the highest degree of care, transparency, and respect.
          </p>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
            This Privacy Policy describes the information we collect when you access or use the TLS website at thelegalspace.com and our mobile application (collectively, the "Platform"), why we collect it, how we use and protect it, and the rights you have in relation to it. It applies to all users of the Platform, regardless of whether you are a lawyer, a law firm, or a client.
          </p>
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">2. Scope of This Privacy Policy</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        {/* ── 3. Definitions ── */}
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">3. Definitions</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">4. Information We Collect</h2>

          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">4.1 Information You Provide to Us</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
            When you register for and use the Platform, you provide us with personal information directly. The nature and extent of that information varies depending on the type of account you create.
          </p>
          ...
          <p className="text-[14px] text-gray-700 leading-7 mb-2 underline">
            Lawyers
          </p>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
            In addition to the information above, lawyers provide professional details including their bio and professional summary, practice areas, Call to Bar details (year and jurisdiction), firm name where applicable, National Identification Number (NIN), and CAC or business registration information where applicable.
          </p>
          ...
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
            Law firms provide organisational information including the firm name, CAC registration details, business address, contact information for the firm, and details of member lawyers added to the firm account, up to a maximum of seven members.
          </p>
          ...
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
            Users may upload content to the Platform, including profile pictures, documents, images, PDFs, and other files shared through the messaging or community features. Any such content is stored on our servers and is associated with your account.
          </p>
          ...
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
            Where you participate in the TLS community, we collect the content you post, any reports you submit regarding other users or content, and records of accounts you follow.
          </p>
          ...
          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">4.2 Information Collected Automatically</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
            When you access the Platform, certain information is collected automatically by our systems and third-party services. This includes device type and operating system, browser type and version, IP address, pages visited and features accessed, time and date of access, and session duration and usage patterns.
          </p>
          <p className="text-[14px] text-gray-700 leading-7">
            This information is collected primarily for security, debugging, and platform improvement purposes. Our hosting infrastructure is provided by Vercel, and technical logs generated through the normal operation of the Platform may include some of this data. These logs are used for debugging and are not used for individual user profiling.
          </p>
        </section>

        {/* ── 5. How We Use Your Information ── */}
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">5. How We Use Your Information</h2>

          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">5.1 Account Creation and Management</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
            We use your registration information to create and manage your account, verify your identity, maintain your profile, and provide you with access to the features available to your user type. Identity and professional information — including NIN and Call to Bar details for lawyers and CAC registration for law firms — is collected to ensure that the platform maintains accurate, credible professional profiles.
          </p>

          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">5.2 Platform Features and Services</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
          ...
          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">5.3 AI-Powered Lawyer Matching</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
          ...
          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">5.4 Communications</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
          ...
          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">5.5 Payments and Billing</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
            We use transaction data to process payments, confirm subscriptions, issue receipts, and maintain financial records. Payment processing is handled by Paystack, and we retain only the metadata necessary to maintain accurate billing records on your account.
          </p>

          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">5.6 Safety, Security, and Integrity</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
            We use account and activity logs to detect and prevent fraudulent activity, monitor for policy violations, investigate reports submitted by users, enforce our Terms of Service, and maintain the security and integrity of the Platform. This includes reviewing content reported by users and taking appropriate action where violations are found.
          </p>

          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">5.7 Platform Improvement and Debugging</h3>
          <p className="text-[14px] text-gray-700 leading-7">
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">6. Legal Bases for Processing</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">7. AI and Automated Processing</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">8. Cookies and Similar Technologies</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">9. Third-Party Services</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">10. Data Sharing and Disclosure</h2>

          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">10.1 Public Profile Information</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
          ...
          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">10.2 Service Providers</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
          ...
          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">10.3 Legal Obligations</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
          ...
          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">10.4 Protection of Rights</h3>
          <p className="text-[14px] text-gray-700 leading-7 mb-4">
          ...
          <h3 className="text-[14px] font-semibold text-gray-900 mb-2">10.5 Business Transfers</h3>
          <p className="text-[14px] text-gray-700 leading-7">
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">11. International Data Transfers</h2>
          <p className="text-[14px] text-gray-700 leading-7">
        ...
        {/* ── 12. Data Security ── */}
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">12. Data Security</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
          ...
          <p className="text-[14px] text-gray-700 leading-7">
            Despite these measures, no method of data transmission or storage can be guaranteed to be completely secure. We encourage users to take responsibility for their account security by using strong passwords and keeping their login credentials confidential. If you believe your account has been compromised, please contact us immediately at{" "}
        ...
        {/* ── 13. Data Retention ── */}
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">13. Data Retention</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        {/* ── 14. Your Rights ── */}
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">14. Your Rights</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        {/* ── 15. Account Deletion ── */}
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">15. Account Deletion</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
          ...
          <p className="text-[14px] text-gray-700 leading-7">
            If you have a pending subscription or upcoming transactions, we recommend managing these before initiating account deletion. For assistance, contact us at{" "}
            <a href="mailto:thelegalspace01@gmail.com" className="text-blue-600 hover:underline">
              thelegalspace01@gmail.com
            </a>.
          </p>
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">16. Children's Privacy</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">17. Marketing Communications</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        {/* ── 18. Platform Notifications ── */}
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">18. Platform Notifications</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
        ...
        <section className="mb-7">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">19. Changes to This Privacy Policy</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
          ...
          <p className="text-[14px] text-gray-700 leading-7">
            Your continued use of the Platform after any such update constitutes your acknowledgement of the revised Policy. If you do not agree with the updated Policy, you should cease use of the Platform and, if you wish, delete your account. We encourage you to review this Privacy Policy periodically to stay informed about how we are protecting your information.
          </p>
        </section>

        {/* ── 20. Contact Information ── */}
        <section className="mb-12">
          <h2 className="text-[15px] font-bold text-gray-900 mb-3">20. Contact Information</h2>
          <p className="text-[14px] text-gray-700 leading-7 mb-3">
