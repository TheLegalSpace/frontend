...
export default function EventsPanel() {
  ...
  return (
    <div className="flex flex-col gap-3 lg:sticky lg:top-4 font-[Instrument_Serif]">
      ...
      {/* Event Card */}
      <div className="bg-[#F4F4F4] rounded-xl p-2.5">
        {isLoading && (
          <div className="h-64 rounded-xl bg-white flex items-center justify-center text-xs text-gray-400">
            Loading events...
          </div>
        )}
        ...
        {!isLoading && activeEvent && (
          <>
            ...
            {/* CTA */}
            <button className="w-full mt-3 h-9 rounded-lg bg-[#ECECEC] hover:bg-[#1D4ED8] hover:text-white transition-all duration-300 text-[12px] font-medium text-[#2A2B2D] flex items-center justify-center gap-1.5">
              Register for Event
            ...
            <div className="mt-3 px-1">
              ...
              <h3 className="text-[13px] font-medium leading-snug text-[#111827] mb-2">
                {activeEvent.title}
              </h3>
        ...
        {!isLoading && !events.length && (
          <div className="h-40 rounded-xl bg-white flex items-center justify-center text-xs text-gray-400">
            No upcoming events
          </div>
        )}
      </div>
