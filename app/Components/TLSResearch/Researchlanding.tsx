...
const CAPABILITIES = [
  {
    ...
    iconColor: "#d97706",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#d97706" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
        <line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="19" y2="18"/>
  ...
  },
  {
    iconBg: "bg-blue-100",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2563eb" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    iconBg: "bg-pink-100",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#db2777" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
        <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
  ...
  },
  {
    iconBg: "bg-green-100",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#16a34a" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
...
const NOT_FOR = [
  {
    iconBg: "bg-amber-100",
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#d97706" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#ea580c" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    iconBg: "bg-pink-100",
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#be185d" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    iconBg: "bg-violet-100",
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#6d28d9" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
        <line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="19" y2="18"/>
        <line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/>
      </svg>
    ),
...
export default function ResearchLanding({ onSuggestion, onNewThread, onUploadAndNew }: Props) {
  return (
    <div className="flex-1 overflow-y-auto bg-white font-['Geist']">
      ...
      <div className="max-w-3xl mx-auto px-6 pb-8">
        <div className="mb-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-[10px] uppercase tracking-widest text-gray-400">Capabilities</p>
          </div>
          <h2 className="text-[20px] font-normal text-gray-900 font-['Instrument_Serif']">
            What TLS Research Can Help With
          </h2>
          <p className="text-[13px] text-gray-500 mt-1">
            Built specifically for legal professionals and research-driven workflows.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {CAPABILITIES.map((cap) => (
            ...
            >
              <div className={`w-9 h-9 rounded-lg ${cap.iconBg} flex items-center justify-center mb-3`}>
                {cap.icon}
              </div>
              <p className="text-[13px] font-medium text-gray-900 mb-1">{cap.title}</p>
              <p className="text-[12px] text-gray-500 leading-relaxed">{cap.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 pb-8">
        <div className="mb-5">
          ...
          <p className="text-[13px] text-gray-500 mt-1">
            TLS Research is focused — not general-purpose. Understanding its scope produces better results.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {NOT_FOR.map((item) => (
            ...
            >
              ...
              <p className="text-[12px] font-semibold text-gray-800 mb-1">{item.title}</p>
      ...
      <div className="max-w-3xl mx-auto px-6 pb-12">
        <div className="rounded-2xl bg-gray-900 px-8 py-8 flex items-center justify-between gap-6">
          <div>
            <p className="text-[10px] uppercase tracking-widest text-gray-500 mb-1">Ready</p>
            <h3 className="text-[22px] font-medium text-white font-['Instrument_Serif']">
              Start Researching
            </h3>
            <p className="text-[13px] text-gray-400 mt-1">
              Explore legal materials, research authorities, and work smarter with TLS Research.
            </p>
          </div>
