...
const PREVIEW_ARTICLES = [
  {
    ...
    date: "4 hours ago",
    title: "FIRS Issues New Transfer Pricing Compliance Circular for Multinational Entities Operating in Nigeria",
    excerpt:
  ...
  },
  {
    ...
    date: "Yesterday",
    title: "Supreme Court Rules on Constructive Dismissal: What Employers Must Know",
    excerpt:
  ...
  return (
    <div className="min-h-screen bg-white font-['Geist']">
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        {/* Page title */}
        <h1 className="text-[22px] font-medium text-gray-900 font-['Instrument_Serif'] mb-6 border-b border-gray-100 pb-4">
          Legal News
        </h1>
        ...
        <div className="relative rounded-xl border border-gray-200 overflow-hidden mb-6">
          {/* Blur overlay */}
          <div className={`absolute inset-0 z-10 flex flex-col items-center justify-center transition-all duration-300 ${showPreview ? "backdrop-blur-none bg-transparent pointer-events-none" : "backdrop-blur-xl bg-white/40"}`}>
            {!showPreview && (
              <div className="flex flex-col items-center">
                ...
                <p className="text-[12px] text-gray-500 mt-2">Help shape what TLS News becomes…</p>
              </div>
            )}
          </div>
        ...
        <p className="text-[14px] text-gray-600 leading-relaxed mb-6">
          <span className="font-semibold text-gray-900">Before</span> we launch publicly, we want to understand whether legal professionals would actively use a legal news experience inside The Legal Space.
        </p>
          ...
          <>
            ...
            <div className="mb-8">
              ...
              <p className="text-[12px] text-gray-400 mb-4">
                Please choose all options that are relevant to you. This information will assist us in determining which coverage areas to prioritise.
              </p>
